...
@Component({
  selector: "app-pubmed-articles-import-component",
  imports: [
    FormsModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  templateUrl: "./pubmed-articles-import-component.html",
  styleUrl: "./pubmed-articles-import-component.scss",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PubmedArticlesImportComponent {
